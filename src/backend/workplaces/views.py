...
from workplaces.schemas import DeviceDriversReadSchema, ScalesReadSchema, WorkplaceReadSchema
from workplaces.service import drivers_service, scales_service, workplaces_service
...
async def get_all_drivers(
    ...
    scales = await drivers_service.get_all_drivers(session)
