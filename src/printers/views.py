...
async def web_printer_test_connection(
    ...
    return await printers_service.test_connection(printer)
...
async def web_get_all_printers(
    ...
    all_printers = await printers_service.get_all(session)
...
async def web_create_printer_form(
    ...
    context = await printers_service.create_form(session)
...
async def web_create_printer(
    ...
    printer_id: int | None = await printers_service.create(session, ip, port, driver_name, description)
...
async def web_update_printer_form(
    ...
    context = await printers_service.update_form(session, printer_id)
...
async def web_update_printer(
    ...
    updated_printer_id: int | None = await printers_service.update(session, printer_id, ip, port, driver_name, description)
