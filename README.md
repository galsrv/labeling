...
3. В файле `src/drivers/scales/simulator.py` заполните ip-адрес и порт созданных в приложении весов, укажите диапазон веса для генерации случайных значений. 
4. Запустите `simulator.py` во втором терминале командой `python -m drivers.scales.simulator`
